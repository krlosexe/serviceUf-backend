<div class="card shadow mb-4 hidden" id="cuadro4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Editar Cotizacion</h6>
  </div>
  <div class="card-body">
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <br>
                          <button type="button" class="btn btn-primary btn-user" id="add_pay_edit">
                            Agregar Pago
                          </button>


                          <div id="content_pay_edit">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <label for=""><b>Saldo</b></label>
                                <div class="form-group valid-required">
                                  <input type="text" class="form-control" name="balance" id="balance_edit" value="0" style="text-align: right;">
                                </div>
                            </div>
                          </div>
