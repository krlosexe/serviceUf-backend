		      ...
		      <div id="content">
		        ...
		        <!-- Begin Page Content -->
			        <div class="container-fluid">
			          ...
			          <!-- Page Heading -->
			          <h1 class="h3 mb-2 text-gray-800">Remisiones</h1>
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Gestion de Remision de Productos</h6>
			          ...
			          @include('warehouse.remisiones.store')
					  @include('warehouse.remisiones.view')
					  @include('warehouse.remisiones.edit')
	...
	@section('CustomJs')
		...
		<script>
			$(document).ready(function(){
				...
				$("#nav_remisiones, #modulo_Almacen").addClass("active");

				verifyPersmisos(id_user, tokens, "output");
			});
			function update(){
				enviarFormularioPut("#form-update", 'api/products/remision', '#cuadro4', false, "#avatar-edit");
			}
			function store(){
				enviarFormulario("#store", 'api/products/remision', '#cuadro2');
			}
			function list(cuadro) {
				...
				var table=$("#table").DataTable({
					...
					"ajax":{
						"method":"GET",
						 "url":''+url+'/api/products/reemision/list',
						 "data": {
							"id_user": id_user,
							"token"  : tokens,
						},
