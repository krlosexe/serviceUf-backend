			        ...
			        <div class="container-fluid">
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Gestion de Egresos</h6>
			          ...
			          @include('warehouse.expenses.store')
					  @include('warehouse.expenses.view')
					  @include('warehouse.expenses.edit')
	...
	@section('CustomJs')
		...
		<script>
			$(document).ready(function(){
				...
				$("#nav_expenses, #modulo_Almacen").addClass("active");
			...
			function update(){
				enviarFormularioPut("#form-update", 'api/expenses', '#cuadro4', false, "#avatar-edit");
			}


			function store(){
				enviarFormulario("#store", 'api/expenses', '#cuadro2');
			}
						...
						{"data": null,
							render : function(data, type, row) {
								...
								if(consultar == 1)
									...
									botones += "<a href='api/expenses/print/"+row.id+"' target='_blank' class='print btn btn-sm btn-success waves-effect' data-toggle='tooltip' title='Imprmir'><i class='fas fa-print' style='margin-bottom:5px'></i></a> ";
								return botones;
							}
						},
						{"data":"id"},
			...
			*/
			function ver(tbody, table){
				$(tbody).on("click", "span.consultar", function(){
					...
					$("#commercial_premises_view").val(data.name_cc).attr("disabled", "disabled")
					$("#name_view").val(data.name).attr("disabled", "disabled")
					$("#concept_view").val(data.concept).attr("disabled", "disabled")
					$("#value_view").val(data.value).attr("disabled", "disabled")
			...
			*/
			function desactivar(tbody, table){
				$(tbody).on("click", "span.desactivar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/expenses/status/'+data.id+"/"+2,"¿Esta seguro de desactivar el registro?", 'desactivar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			*/
			function activar(tbody, table){
				$(tbody).on("click", "span.activar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/expenses/status/'+data.id+"/"+1,"¿Esta seguro de desactivar el registro?", 'activar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			function eliminar(tbody, table){
				$(tbody).on("click", "span.eliminar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/expenses/status/'+data.id+"/"+0,"¿Esta seguro de eliminar el registro?", 'Eliminar');
				});
			}
