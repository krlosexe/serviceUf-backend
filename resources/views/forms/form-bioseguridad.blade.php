      ...
      <form class="user" autocomplete="off" method="post" id="store" enctype="multipart/form-data">
        ...
        <div class="row">
           ...
           <div class="col-md-12">
              ...
              ELTRABAJADOR DECLARA QUE LA INFORMACIÓN CONTENIDA EN EL PRESENTE CUESTIONARIO ES AUTENTICA Y CORRESPONDE A LA VERDAD,  POR LO CUAL REALIZA EL ENVIO DEL PRESENTE  FORMULARIO-CUESTIONARIO VIA WEB CON SU NOMBRE COMPLETO Y NUMERO DE DOCUMENTO. 
