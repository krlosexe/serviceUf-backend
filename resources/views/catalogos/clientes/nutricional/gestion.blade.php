		      ...
		      <div id="content">
		        ...
		        <!-- Begin Page Content -->
			        <div class="container-fluid">
			          ...
			          <!-- Page Heading -->
			          <h1 class="h3 mb-2 text-gray-800">Nutricional</h1>
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Gestion de Citas de Nutrición</h6>
			          ...
			          @include('catalogos.clientes.nutricional.store')
					  @include('catalogos.clientes.nutricional.view')
					  @include('catalogos.clientes.nutricional.edit')
...
<script>
			...
			function list(cuadro) {
				...
				var table=$("#table").DataTable({
					...
					"ajax":{
						"method":"GET",
						 "url":''+url+'/api/nutricional/client/'+{{ $id_client }},
						 "data": {
							"rol"    : name_rol,
							"id_user": id_user,
							"token"  : tokens,
			...
			*/
			function edit(tbody, table){
				$(tbody).on("click", "span.editar", function(){
					...
					var url_imagen = '/img/nutricional/primera/'
					var url        = document.getElementById('ruta').value;


					if((data.nutri != "" ) &&  (data.nutri != null)){
						var ext = data.nutri.split('.');
						if (ext[1] == "pdf") {
							img = '<embed class="kv-preview-data file-preview-pdf" src="'+url+url_imagen+data.nutri+'" type="application/pdf" style="width:213px;height:160px;" internalinstanceid="174">'
						}else{
							img = '<img src="'+url+url_imagen+data.nutri+'" class="file-preview-image kv-preview-data">'
						}

					}else{img = ""}

					
					$("#nutri_edit").fileinput('destroy');
					$("#nutri_edit").fileinput({
						theme: "fas",
						overwriteInitial: true,
						maxFileSize: 1500,
						showClose: false,
