		      ...
		      <div id="content">
		        ...
		        <!-- Begin Page Content -->
			        <div class="container-fluid">
			          ...
			          <!-- Page Heading -->
			          <h1 class="h3 mb-2 text-gray-800">Hiperbarica</h1>
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Gestion de Citas de Camara Hiperbarica</h6>
			          ...
			          @include('catalogos.clientes.hiperbarica.store')
					  @include('catalogos.clientes.hiperbarica.view')
					  @include('catalogos.clientes.hiperbarica.edit')
...
<script>
			...
			function list(cuadro) {
				...
				var table=$("#table").DataTable({
					...
					"ajax":{
						"method":"GET",
						 "url":''+url+'/api/hiperbarica/client/'+{{ $id_client }},
						 "data": {
							"rol"    : name_rol,
							"id_user": id_user,
							"token"  : tokens,
