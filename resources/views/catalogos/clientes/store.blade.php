                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="tipo_identificacion" id="tipo_identificacion_edit" class="form-control">
                                        <option value="">Seleccione</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="friend_facebook" class="form-control form-control-user" id="friend_facebook">
                            </div>

                            <div class="form-group col-md-6">
                                <label for=""><b>Seguidores en Instagram</b></label>
                                <input type="text" name="followers_instagram" class="form-control form-control-user" id="followers_instagram">
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="row" id="content_acquittance">
                        <div class="col-sm-12 text-center">
                            ...
                            <div>
                                <div class="file-loading">
                                  <input id="nutricional" name="nutricional_file" type="file">
