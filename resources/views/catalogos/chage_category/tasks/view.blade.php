<div class="card shadow mb-4 hidden" id="cuadro3">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Consulta de Tarea</h6>
  </div>
  <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                        ...
                        <select name="responsable" id="responsable-view" class="form-control select2 getUsers" required>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                        ...
                        <select name="followers[]" id="followers-view" class="form-control select2 getUsers" multiple required>
                            <option value="">Seleccione</option>
                        </select>
                    </div>
                </div>
