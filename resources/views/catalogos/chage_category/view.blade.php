  ...
  <div class="card-body">
      <form class="user" autocomplete="off" method="post" id="form-view" enctype="multipart/form-data">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li  class="nav-item">
                <a id="tab01" class="nav-link active" id="patient_record_view" data-toggle="tab" href="#init_view" role="tab" aria-controls="init" aria-selected="true">Ficha</a>
            </li>
            <li  class="nav-item">
                <a id="tab11" class="nav-link" id="information_aditionals_view" data-toggle="tab" href="#info-add-view" role="tab" aria-controls="info-add" aria-selected="false">Info Cirugia</a>
            </li>

            <li  class="nav-item">
                <a id="tab21" class="nav-link" id="init_history_view" data-toggle="tab" href="#init-history-view" role="tab" aria-controls="info-add" aria-selected="false">Historial Clinico</a>
            </li>

            <li  class="nav-item">
                <a id="tab31" class="nav-link" id="info_credit_patient_view" data-toggle="tab" href="#info-credit-patient-view" role="tab" aria-controls="info-add" aria-selected="false">Info Crediticia</a>
            </li>


            <li  class="nav-item" id="tab4_view">
                <a id="tab41" class="nav-link"  data-toggle="tab" href="#info-valuations-view" role="tab" aria-controls="info-add" aria-selected="false">Valoraciones</a>
            </li>


            <li  class="nav-item" id="tab5_view">
                <a id="tab41" class="nav-link"  data-toggle="tab" href="#info-preanestesia-view" role="tab" aria-controls="info-add" aria-selected="false">Pre Anestesias</a>
            </li>


            <li  class="nav-item" id="tab6_view">
                <a id="tab41" class="nav-link"  data-toggle="tab" href="#info-cirugias-view" role="tab" aria-controls="info-add" aria-selected="false">Cirugias</a>
            </li>

            <li  class="nav-item" id="tab7_view">
                <a id="tab41" class="nav-link"  data-toggle="tab" href="#info-revision-view" role="tab" aria-controls="info-add" aria-selected="false">Revisiones</a>
            </li>

            <li  class="nav-item" id="tab8_view">
                <a id="tab42" class="nav-link"  data-toggle="tab" href="#info-tracing-view" role="tab" aria-controls="info-add" aria-selected="false">Seguimientos</a>
            </li>
