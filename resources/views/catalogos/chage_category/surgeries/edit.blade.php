<div class="card shadow mb-4 hidden" id="cuadro4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Editar Procedimientos</h6>
  </div>
  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                              ...
                              <input type="text" name="surgerie_name" id="surgerie_name_edit" class="form-control" required >
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-2">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="amount" id="amount-edit" class="form-control" onkeydown="noPuntoComa( event )" required>
                        </div>
                      </div>
                    </div>
