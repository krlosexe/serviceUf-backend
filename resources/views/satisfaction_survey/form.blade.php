            ...
            <form action="">
            	...
            	<div id="wizard">
                    <form action="af" method="POST" id="formss">
                        ...
                        <section>
                            <div class="form-row" style="margin-bottom: 26px;">
                                <h4>4 - Tiempo para organizar el proceso quirúrgico</h4>
                            </div>
                        ...
                        <section>
                            <div class="form-row" style="margin-bottom: 26px;">
                                <h4>5 - Cómo fue la atención que recibió por parte de la asesora antes, durante y después de la intervención</h4>
                            </div>
                        ...
                        <section>
                            <div class="form-row" style="margin-bottom: 26px;">
                                <h4>6 - Amabilidad (cortesía) del personal en el trato con los pacientes</h4>
                            </div>
                        ...
                        <section>
                            <div class="form-row" style="margin-bottom: 26px;">
                                <h4>7 - Interés del personal para organizar las citas de revisión</h4>
                            </div>
                        ...
                        <section>
                            <div class="form-row" style="margin-bottom: 26px;">
                                <h4>8 - Tiempo en responder mensajes, llamadas</h4>
                            </div>

                            <div class="form-row" style="margin-bottom: 26px;">
                            
                                <div class="form-field" style="width: 100%">
                                    <select name="question8" id="question8" class="star-rating">
                                        <option value="">Select a rating</option>
                                        <option value="5">Exelente</option>
                                        <option value="4">Muy Bueno</option>
                                        <option value="3">Bueno</option>
                        ...
                        <section>
                            <div class="form-row" style="margin-bottom: 26px;">
                                <h4>9 - El trato personalizado que tiene con los pacientes</h4>
                            </div>

                            <div class="form-row" style="margin-bottom: 26px;">
                            
                                <div class="form-field" style="width: 100%">
                                    <select name="question9" id="question9" class="star-rating">
                                        <option value="">Select a rating</option>
                                        <option value="5">Exelente</option>
                                        <option value="4">Muy Bueno</option>
                                        <option value="3">Bueno</option>
                        ...
                        <section>
                            <div class="form-row" style="margin-bottom: 26px;">
                                <h4>10 - Atención y seguridad que brinda todo el personal de la clínica</h4>
                            </div>

                            <div class="form-row" style="margin-bottom: 26px;">
                            
                                <div class="form-field" style="width: 100%">
                                    <select name="question10" id="question10" class="star-rating">
                                        <option value="">Select a rating</option>
                                        <option value="5">Exelente</option>
                                        <option value="4">Muy Bueno</option>
                                        <option value="3">Bueno</option>
	...
	<script>
        ...
        $(document).ready(function(){
            ...
            $(".actions a[href$='#finish']").click(function (e) { 
                ...
                $.ajax({
                    url:'<?= url('/') ?>/api/satisfaction_survey',
                    type:"POST",
                    dataType:'JSON',
                    data:data,
