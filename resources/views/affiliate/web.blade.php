...
<head>
  ...
  <body class="{{ Request::path() != '/' ? 'dasboard-body' : ''}} bg-gradient-primary"  background: #fff !important;
  ">
...
<div class="card shadow mb-4 " id="cuadro2">
 ...
 <!-- Page level plugins -->
  ...
  <script>
	...
	function store(){
		id_user = 69;
		enviarFormularioForm("#store", 'api/register/referred', '#cuadro2');
	}
