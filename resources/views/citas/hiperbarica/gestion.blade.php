		      ...
		      <div id="content">
		        ...
		        <!-- Begin Page Content -->
			        <div class="container-fluid">
			          ...
			          <!-- Page Heading -->
			          <h1 class="h3 mb-2 text-gray-800">Cita para camara hiperbarica</h1>
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Gestion de Citas de para camara hiperbarica</h6>
			          ...
			          @include('citas.hiperbarica.store')
					  @include('citas.hiperbarica.view')
					  @include('citas.hiperbarica.edit')
	...
	@section('CustomJs')
		...
		<script>
			$(document).ready(function(){
				...
				$("#nav_hiperbarica, #modulo_Citas").addClass("active");
			...
			function update(){
				enviarFormularioPut("#form-update", 'api/hiperbarica', '#cuadro4', false, "#avatar-edit");
			}

			function store(){
				enviarFormulario("#store", 'api/hiperbarica', '#cuadro2');
			}
			...
			*/
			...
			function edit(tbody, table){
				$(tbody).on("click", "span.editar", function(){
					...
					$('#summernote_edit').summernote("reset");
					GetComments("#comments_edit", data.id_hiperbarica, data.observaciones)

					SubmitComment(data.id_hiperbarica, "api/comments/hiperbarica", "#comments_edit", "#add-comments", "#summernote_edit")
					...
					$("#id_edit").val(data.id_hiperbarica)
					cuadros('#cuadro1', '#cuadro4');
				});
			}
			...
			function GetComments(comment_content, id, observaciones){
				...
				var url=document.getElementById('ruta').value;
				$.ajax({
					url:''+url+'/api/comments/hiperbarica/'+id,
					type:'GET',
					dataType:'JSON',
			...
			*/
			function desactivar(tbody, table){
				$(tbody).on("click", "span.desactivar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/hiperbarica/status/'+data.id_hiperbarica+"/"+2,"¿Esta seguro de desactivar el registro?", 'desactivar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			*/
			function activar(tbody, table){
				$(tbody).on("click", "span.activar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/hiperbarica/status/'+data.id_hiperbarica+"/"+1,"¿Esta seguro de desactivar el registro?", 'activar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			function eliminar(tbody, table){
				$(tbody).on("click", "span.eliminar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/hiperbarica/status/'+data.id_hiperbarica+"/"+0,"¿Esta seguro de eliminar el registro?", 'Eliminar');
				});
			}
