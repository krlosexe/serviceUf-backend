		      ...
		      <div id="content">
		        ...
		        <!-- Begin Page Content -->
			        <div class="container-fluid">
			          ...
			          <!-- Page Heading -->
			          <h1 class="h3 mb-2 text-gray-800">Examenes</h1>
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Gestion de Citas de Examenes</h6>
			          ...
			          @include('citas.examenes.store')
					  @include('citas.examenes.view')
					  @include('citas.examenes.edit')
	...
	@section('CustomJs')
		...
		<script>
			$(document).ready(function(){
				...
				$("#nav_examenes, #modulo_Citas").addClass("active");
			...
			*/
			function desactivar(tbody, table){
				$(tbody).on("click", "span.desactivar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/examenes/status/'+data.id+"/"+2,"¿Esta seguro de desactivar el registro?", 'desactivar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			*/
			function activar(tbody, table){
				$(tbody).on("click", "span.activar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/examenes/status/'+data.id+"/"+1,"¿Esta seguro de desactivar el registro?", 'activar');
				});
			}
		/* ------------------------------------------------------------------------------- */
			...
			function eliminar(tbody, table){
				$(tbody).on("click", "span.eliminar", function(){
					var data=table.row($(this).parents("tr")).data();
					statusConfirmacion('api/examenes/status/'+data.id+"/"+0,"¿Esta seguro de eliminar el registro?", 'Eliminar');
				});
			}
