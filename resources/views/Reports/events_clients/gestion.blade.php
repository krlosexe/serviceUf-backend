		      ...
		      <div id="content">
		        ...
		        <!-- Begin Page Content -->
			        <div class="container-fluid">
			          ...
			          <!-- Page Heading -->
			          <h1 class="h3 mb-2 text-gray-800">Reporte Actividades de Clientes</h1>
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Gestion de Actividades de Clientes</h6>
	...
	@section('CustomJs')
		...
		<script>
			$(document).ready(function(){
				...
				$("#nav_logs-asesoras, #modulo_Reportes").addClass("active");
			...
			function list(cuadro, adviser) {
				...
				var table=$("#table").DataTable({
					...
					"ajax":{
						"method":"GET",
						 "url":''+url+'/api/logs/events/clients',
						 "data": {
							"adviser"       : adviser
						},
