		      ...
		      <div id="content">
		        ...
		        <!-- Begin Page Content -->
			        <div class="container-fluid">
			          ...
			          <!-- Page Heading -->
			          <h1 class="h3 mb-2 text-gray-800">Viaticos</h1>
			          ...
			          <div class="card shadow mb-4" id="cuadro1">
			            <div class="card-header py-3">
			              <h6 class="m-0 font-weight-bold text-primary">Viaticos</h6>
					  ...
					  @include('wellezy.viaticos.store')
					  @include('wellezy.viaticos.view')
				      @include('wellezy.viaticos.edit')
