  ...
  <div class="card-body">
      <form class="user" autocomplete="off" method="post" id="form-update" enctype="multipart/form-data">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li  class="nav-item">
                <a id="btrx_tab0" class="nav-link active" id="patient_record_edit" data-toggle="tab" href="#init_edit_btrx" role="tab" aria-controls="init" aria-selected="true">Ficha</a>
            </li>
            <li  class="nav-item">
                <a id="btrx_tab1" class="nav-link" id="information_aditionals_edit" data-toggle="tab" href="#info-add-edit" role="tab" aria-controls="info-add" aria-selected="false">Info Cirugia</a>
            </li>

            <li  class="nav-item">
                <a id="btrx_tab2" class="nav-link" id="init_history_edit" data-toggle="tab" href="#init-history-edit" role="tab" aria-controls="info-add" aria-selected="false">Historial Clinico</a>
            </li>

            <li  class="nav-item">
                <a id="btrx_tab3" class="nav-link" id="info_credit_patient_edit" data-toggle="tab" href="#info-credit-patient-edit" role="tab" aria-controls="info-add" aria-selected="false">Info Crediticia</a>
            </li>

            <li  class="nav-item" id="btrx_tab4_edit">
            ...
            <li  class="nav-item" id="btrx_tab5_edit">
                <a id="btrx_tab4" class="nav-link" id="info_credit_patient_edit" data-toggle="tab" href="#info-preanestesia-edit" role="tab" aria-controls="info-add" aria-selected="false">Pre Anestesia</a>
            </li>
            ...
            <li  class="nav-item" id="btrx_tab7_edit">
                <a id="btrx_tab4" class="nav-link"  data-toggle="tab" href="#info-revision-edit" role="tab" aria-controls="info-add" aria-selected="false">Revisiones</a>
            </li>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active tab_content0" id="init_edit_btrx" role="tabpanel" aria-labelledby="patient_record_edit">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="row" id="comments_edit_client">
                            <div class="col-md-12">
                              <div class="row">
                                  <div class="col-md-2">
                                    Foto
