...
class NotificationsValorationsColombian extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registered:NotificationsValorationsColombian';
     ...
     * @var string
     */
    protected $description = 'Recordad valoraciones vencidas Colombian';
