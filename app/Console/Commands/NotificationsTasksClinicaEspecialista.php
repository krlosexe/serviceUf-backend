...
class NotificationsTasksClinicaEspecialista extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registered:NotificationsTasksClinicaEspecialistas';
     ...
     * @var string
     */
    protected $description = 'Notificar tareas vencidas de la linea del ClinicaEspecialistas';
