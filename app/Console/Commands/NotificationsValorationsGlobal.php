...
class NotificationsValorationsGlobal extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registered:NotificationsValorationsGlobal';
     ...
     * @var string
     */
    protected $description = 'Recordad valoracione vencidas Global';
