...
class NotificationsValorationsPlanmed extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registered:NotificationsValorationsPlanmed';
     ...
     * @var string
     */
    protected $description = 'Recordad valoracione vencidas Planmed';
