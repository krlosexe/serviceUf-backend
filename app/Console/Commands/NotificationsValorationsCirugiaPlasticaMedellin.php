...
class NotificationsValorationsCirugiaPlasticaMedellin extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registered:NotificationsValorationsCirugiaPlasticaMedellin';
     ...
     * @var string
     */
    protected $description = 'Recordad valoraciones vencidas CirugiaPlasticaMedellin';
