...
class NotificationsValorationsLaser extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registered:NotificationsValorationsLaser';
     ...
     * @var string
     */
    protected $description = 'Recordad valoraciones vencidas Laser';
