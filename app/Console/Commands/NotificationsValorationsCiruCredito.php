...
class NotificationsValorationsCiruCredito extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registered:NotificationsValorationsCiruCredito';
     ...
     * @var string
     */
    protected $description = 'Recordad valoraciones vencidas CiruCredito';
