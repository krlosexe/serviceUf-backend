...
class NotificationsCirugiaPlasticaMedellin extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registered:NotificationsTasksCirugiaPlasticaMedellin';
     ...
     * @var string
     */
    protected $description = 'Notificar tareas vencidas de la linea del CirugiaPlasticaMedellin';
