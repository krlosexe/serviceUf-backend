...
class NotificationsValorationsEspecialista extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registered:NotificationsValorationsEspecialista';
     ...
     * @var string
     */
    protected $description = 'Recordad valoraciones vencidas Especialista';
