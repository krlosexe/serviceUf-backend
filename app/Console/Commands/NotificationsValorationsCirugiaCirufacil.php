...
class NotificationsValorationsCirugiaCirufacil extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registered:NotificationsValorationsCiruFacil';
     ...
     * @var string
     */
    protected $description = 'Recordad valoraciones vencidas CiruFacil';
