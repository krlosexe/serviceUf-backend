...
class NotificationsTasksCiruCredito extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registered:NotificationsTasksCiruCredito';
     ...
     * @var string
     */
    protected $description = 'Notificar tareas vencidas de la linea del CiruCredito';
