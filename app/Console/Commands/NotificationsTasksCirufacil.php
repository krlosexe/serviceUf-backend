...
class NotificationsTasksCirufacil extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registered:NotificationsTasksCiruFacil';
     ...
     * @var string
     */
    protected $description = 'Notificar tareas vencidas de la linea del CiruFacil';
